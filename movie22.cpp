#include "movie22.h"
#include "ui_movie22.h"
#include <QDebug>
#include "page4.h"
#include "global.h"
movie22::movie22(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::movie22)
{
    ui->setupUi(this);
    ...
    if(MD[21] == "Marvel's The Avengers"){
//        qDebug() << "hena 1";
...
void movie22::on_pushButton_2_clicked()
{
