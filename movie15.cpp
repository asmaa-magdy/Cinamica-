#include "movie15.h"
#include "ui_movie15.h"
#include <QDebug>
#include "page3.h"
#include "global.h"
movie15::movie15(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::movie15)
{
    ui->setupUi(this);
    ...
    if(MD[14] == "Marvel's The Avengers"){
//        qDebug() << "hena 1";
...
void movie15::on_pushButton_2_clicked()
{
    Page3 p;
    p.setModal(true);
    this->hide();
