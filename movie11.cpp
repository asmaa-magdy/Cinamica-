#include "movie11.h"
#include "ui_movie11.h"
#include <QDebug>
#include "page2.h"
#include "global.h"

movie11::movie11(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::movie11)
{
    ui->setupUi(this);
    ...
    if(MD[10] == "Marvel's The Avengers"){
//        qDebug() << "hena 1";
...
void movie11::on_pushButton_2_clicked()
{
