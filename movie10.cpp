#include "movie10.h"
#include "ui_movie10.h"
#include "global.h"
#include "page2.h"
#include <QDebug>

movie10::movie10(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::movie10)
{
    ui->setupUi(this);
...
void movie10::on_pushButton_2_clicked()
{
    Page2 p;
    p.setModal(true);
    this->hide();
