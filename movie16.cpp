#include "movie16.h"
#include "ui_movie16.h"
#include <QDebug>
#include "page3.h"
#include "global.h"
movie16::movie16(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::movie16)
{
    ui->setupUi(this);
    ...
    if(MD[15] == "Marvel's The Avengers"){
//        qDebug() << "hena 1";
...
void movie16::on_pushButton_2_clicked()
{
    Page3 p;
    p.setModal(true);
    this->hide();
