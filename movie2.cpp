...
//    ui->stars->setStyleSheet("font: bold 14px;");
//    ui->Writer->setStyleSheet("font: bold 14px;");
//    ui->MovieName->setText(det[1].movie);
//    ui->Category->setText(det[1].type);
//    ui->textEdit->setText(det[1].detail);
//    ui->Writer->setText(det[1].writers);
//    ui->Director->setText(det[1].director);
//    ui->stars->setText(det[1].stars);
//    QPixmap pix("/home/asmaa/QT/CINAMIKA/The_Last_Exorcism_Poster.jpg");
//    ui->pictureLabel->setPixmap(pix);
//    ui->pictureLabel->setScaledContents(true);
}
...
void movie2::on_pushButton_2_clicked()
{
    view v;
    v.setModal(true);
    this->hide();
