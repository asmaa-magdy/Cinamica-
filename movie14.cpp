#include "movie14.h"
#include "ui_movie14.h"
#include <QDebug>
#include "page3.h"
#include "global.h"
movie14::movie14(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::movie14)
{
    ui->setupUi(this);
    ...
    if(MD[13] == "Marvel's The Avengers"){
//        qDebug() << "hena 1";
...
void movie14::on_pushButton_2_clicked()
{
    Page3 p;
    p.setModal(true);
    this->hide();
