    ...
    ui(new Ui::movi17)
{
    ...
    if(MD[16] == "Marvel's The Avengers"){
//        qDebug() << "hena 1";
...
void movi17::on_pushButton_2_clicked()
{
    Page3 p;
    p.setModal(true);
    this->hide();
