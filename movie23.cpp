#include "movie23.h"
#include "ui_movie23.h"
#include <QDebug>
#include "page4.h"
#include "global.h"
movie23::movie23(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::movie23)
{
    ui->setupUi(this);
    ...
    if(MD[22] == "Marvel's The Avengers"){
//        qDebug() << "hena 1";
...
void movie23::on_pushButton_2_clicked()
{
